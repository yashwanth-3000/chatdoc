...
async def run_test():
    ...
    try:
        ...
        # -> Open the builder page at /builder/step-two/existing-foundry-user and check for the judge/evaluator option containing the text 'No TrueFoundry account?'.
        ...
        # -> Click the 'Continue as judge - use demo tenant' button to begin a credential-free demo tenant connection.
