...
import styles from "./config-viewer.module.css";
...
type Props = {
  files: ConfigFile[];
  botName: string;
  downloadFileUrl: (botName: string, filePath: string) => string;
...
export function ConfigViewer({ files, botName, downloadFileUrl, sidebarTop, sidebarBottom }: Props) {
              ...
              <div className={styles.previewHeader}>
                ...
                <div className={styles.previewActions}>
                  ...
                  <a
                    ...
                    href={downloadFileUrl(botName, activeFile.relative_path)}
                  >
                    Download
                  </a>
                  <button
